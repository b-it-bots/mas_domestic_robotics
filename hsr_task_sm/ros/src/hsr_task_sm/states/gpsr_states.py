...
# ---------------------------------------------------------------------------
KNOWN_LOCATIONS = [
    # Navigation goals from german_open_2026/navigation_goals.yaml
    'home', 'door1_inside', 'door1_outside', 'door2_entrance',
    'bedroom_enterance', 'bed_right', 'bedside_table', 'bedroom_table',
    'cabinet', 'cabinet_near', 'cabinet_far',
    'living_room_table', 'living_room_far', 'living_room_left', 'living_room_tv',
    'inspection_point', 'dining_table', 'dining_table_right',
    'dining_table_left', 'dining_table_far',
    'dish_washer', 'fridge', 'shelf',
    'dust_bin', 'dustbin_far',
    'seating_three', 'seating_four', 'greeting',
]
