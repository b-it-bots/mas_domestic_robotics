...
class BasePlannerClient(ScenarioStateBase):
    def __init__(self, save_sm_state=False, **kwargs):
        ScenarioStateBase.__init__(self, 'base_planner_client',
        ...
        self.client = actionlib.SimpleActionClient('mdr_actions/base_plan_server', BasePlannerAction)
