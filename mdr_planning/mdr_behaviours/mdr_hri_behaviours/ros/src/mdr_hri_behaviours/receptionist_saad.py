...
class ReceptionistTask():
    ...
    def execute(self):
        ...
        name_response="Hello, my name is Saad"
        if name_response:
        ...
        drink_response="I like to drink coffee"
        if drink_response:
...
recep=ReceptionistTask()
recep.extract_information("My name is saad","name")
recep.extract_information("i like coffee","drink")
recep.execute()