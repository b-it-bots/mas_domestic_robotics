...
class search_for_object(smach.State):
	def __init__(self):
		...
		self.object_list_srv = rospy.ServiceProxy('/mcr_perception/object_recognition/get_recognized_objects', mcr_perception_msgs.srv.GetObjectList)
	
	def execute(self, userdata):
		rospy.wait_for_service('/mcr_perception/object_recognition/get_recognized_objects', 10)
...
class detect_object(smach.State):
	def __init__(self):	
		...
		self.object_finder_start = rospy.ServiceProxy('/mcr_perception/tabletop_segmentation/start', std_srvs.srv.Empty)
		self.object_finder_stop = rospy.ServiceProxy('/mcr_perception/tabletop_segmentation/stop', std_srvs.srv.Empty)
...
class find_object_moped(smach.State):
	def __init__(self):	
		...
		self.find_object_srv = rospy.ServiceProxy('/mcr_perception/object_recognition/get_recognized_objects', mcr_perception_msgs.srv.GetObjectList)
		self.object_recognition_start = rospy.ServiceProxy('/mcr_perception/object_recognition/start', std_srvs.srv.Empty)
		self.object_recognition_stop = rospy.ServiceProxy('/mcr_perception/object_recognition/stop', std_srvs.srv.Empty)

	def execute(self, userdata):
		rospy.wait_for_service('/mcr_perception/object_recognition/start', 30)
		rospy.wait_for_service('/mcr_perception/object_recognition/stop', 30)
...
class find_one_known_object(smach.State):
	def __init__(self):	
		...
		self.object_recognition_start = rospy.ServiceProxy('/mcr_perception/object_recognition/start', std_srvs.srv.Empty)
		self.object_recognition_stop = rospy.ServiceProxy('/mcr_perception/object_recognition/stop', std_srvs.srv.Empty)
		self.object_segmentation_start = rospy.ServiceProxy('/mcr_perception/tabletop_segmentation/start', std_srvs.srv.Empty)
		self.object_segmentation_stop = rospy.ServiceProxy('/mcr_perception/tabletop_segmentation/stop', std_srvs.srv.Empty)
	...
	def execute(self, userdata):
		...
		rospy.wait_for_service('/mcr_perception/tabletop_segmentation/start', 30)
		rospy.wait_for_service('/mcr_perception/tabletop_segmentation/stop', 30)
		self.object_segmentation_start()
		self.object_recognition_start()
...
class find_any_known_object(smach.State):
	def __init__(self):	
		...
		self.find_object_srv = rospy.ServiceProxy('/mcr_perception/object_recognition/get_recognized_objects', mcr_perception_msgs.srv.GetObjects)
		self.object_recognition_start = rospy.ServiceProxy('/mcr_perception/object_recognition/start', std_srvs.srv.Empty)
		self.object_recognition_stop = rospy.ServiceProxy('/mcr_perception/object_recognition/stop', std_srvs.srv.Empty)
		self.object_segmentation_start = rospy.ServiceProxy('/mcr_perception/tabletop_segmentation/start', std_srvs.srv.Empty)
		self.object_segmentation_stop = rospy.ServiceProxy('/mcr_perception/tabletop_segmentation/stop', std_srvs.srv.Empty)
...
class categorize_objects(smach.State):
	def __init__(self):
		...
		self.object_recognition_height_based_start = rospy.ServiceProxy('/mcr_perception/object_recognition/start', std_srvs.srv.Empty)
		self.object_recognition_height_based_stop = rospy.ServiceProxy('/mcr_perception/object_recognition/stop', std_srvs.srv.Empty)
